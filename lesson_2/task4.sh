# Создаю дамп единственной таблицы help_keyword базы данных mysql ограничиваясь 100 строками.

dr0n@bozhkov-ubuntu:~$ mysqldump --opt --where="1 limit 100" mysql help_keyword
...
-- Dump completed on 2021-04-20 14:36:20
dr0n@bozhkov-ubuntu:~$